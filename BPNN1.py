...
with open('Result/BPResult/dbzbp.pkl', 'wb') as dbzbp0:
    pkl.dump(avg_tdBZ, dbzbp0)  # 平均dBZ值保存在pkl文件中
with open('Result/BPResult/obbp.pkl', 'wb') as obbp0:
    pkl.dump(real_tRI, obbp0)  # 保存真实降水强度
with open('Result/BPResult/estbp.pkl', 'wb') as estbp0:
    pkl.dump(out, estbp0)  # 保存估算降水强度
with open('Result/BPResult/trainbp.pkl', 'wb') as trainbp0:
    pkl.dump(loss_train, trainbp0)  # 保存真实降水强度
with open('Result/BPResult/testbp.pkl', 'wb') as testbp0:
